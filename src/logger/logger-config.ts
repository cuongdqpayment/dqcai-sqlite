...
import { BaseModule, LoggerConfigBuilder, createLogger, UniversalLogger } from '@dqcai/logger';
...
export class SQLiteLoggerConfig {
  ...
  static createDefaultConfig() {
    return new LoggerConfigBuilder()
      ...
      .addModule(SQLiteModules.DATABASE_MANAGER, false, ['debug', 'info', 'warn', 'error'], ['console'])
      .addModule(SQLiteModules.DATABASE_FACTORY, false, ['debug', 'info', 'warn', 'error'], ['console'])
      
      // DAO and Services - detailed debugging
      .addModule(SQLiteModules.UNIVERSAL_DAO, false, ['trace', 'debug', 'info', 'warn', 'error'], ['console'])
      .addModule(SQLiteModules.BASE_SERVICE, false, ['debug', 'info', 'warn', 'error'], ['console'])
      .addModule(SQLiteModules.SERVICE_MANAGER, false, ['info', 'warn', 'error'], ['console'])
      
      // Query building - can be verbose
      .addModule(SQLiteModules.QUERY_BUILDER, false, ['debug', 'info', 'warn', 'error'], ['console'])
      
      // Adapters - platform specific
      .addModule(SQLiteModules.BASE_ADAPTER, false, ['debug', 'info', 'warn', 'error'], ['console'])
  ...
  static enableModule(moduleName: string, levels?: string[], appenders?: string[]): void {
    if (SQLiteLoggerConfig.currentConfig && SQLiteLoggerConfig.currentConfig.modules) {
  ...
  static createDebugConfig() {
    return new LoggerConfigBuilder()
      ...
      .addModule(SQLiteModules.UNIVERSAL_SQLITE, true, ['trace', 'debug', 'info', 'warn', 'error'], ['console'])
      .addModule(SQLiteModules.DATABASE_MANAGER, true, ['trace', 'debug', 'info', 'warn', 'error'], ['console'])
      .addModule(SQLiteModules.DATABASE_FACTORY, true, ['trace', 'debug', 'info', 'warn', 'error'], ['console'])
      .addModule(SQLiteModules.UNIVERSAL_DAO, true, ['trace', 'debug', 'info', 'warn', 'error'], ['console'])
      .addModule(SQLiteModules.BASE_SERVICE, true, ['trace', 'debug', 'info', 'warn', 'error'], ['console'])
      .addModule(SQLiteModules.SERVICE_MANAGER, true, ['trace', 'debug', 'info', 'warn', 'error'], ['console'])
      .addModule(SQLiteModules.QUERY_BUILDER, true, ['trace', 'debug', 'info', 'warn', 'error'], ['console'])
      .addModule(SQLiteModules.BASE_ADAPTER, true, ['trace', 'debug', 'info', 'warn', 'error'], ['console'])
      .build();
  }
  ...
  static createProductionConfig() {
    return new LoggerConfigBuilder()
      ...
      .addModule(SQLiteModules.DATABASE_MANAGER, true, ['warn', 'error'], ['console'])
      .addModule(SQLiteModules.DATABASE_FACTORY, true, ['warn', 'error'], ['console'])
      ...
      .addModule(SQLiteModules.BASE_ADAPTER, true, ['warn', 'error'], ['console'])
...
export const createModuleLogger = (moduleName: string) => {
  ...
  return {
    trace: (message: string, ...args: any[]) => logger.trace(moduleName, message, ...args),
